    ...
    <section class="card page-block">
      <header class="head">
        <div>
          ...
          <p class="muted">Solicitudes sin asignar, ordenadas por fecha (más reciente primero).</p>
        </div>
      ...
      <div *ngIf="!loading && items.length === 0" class="muted">No hay solicitudes pendientes.</div>
